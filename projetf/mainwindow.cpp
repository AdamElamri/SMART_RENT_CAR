...
void MainWindow::on_imprimer_assureurs_clicked()
{
    int i=0;
    QPrinter printer(QPrinter::HighResolution);
    printer.setPageSize(QPrinter::A4);
    ...
    {
        QSqlQuery query;
        query.prepare("select * from assureurs ");
        QPainter painter (&printer);
             painter.begin(&printer);
             QFont f;
              f.setPointSize(20);
              f.setBold(true);
              painter.setFont(f);
              painter.drawText(1600, 500, " la liste des assureurs:");
        if (query.exec())
        {
            while (query.next())
            {
                ...
                f.setBold(true);
                painter.setFont(f);
                painter.drawText(100, 1000+i, "Identifiant:");
                painter.drawText(1000, 1000+i, query.value(0).toString());
                painter.drawText(100, 1200+i, "nom :");
                painter.drawText(1000, 1200+i, query.value(1).toString());
                painter.drawText(100, 1400+i, "E-mail :");
                painter.drawText(1000, 1400+i, query.value(2).toString());
                painter.drawText(100, 1600+i, "Téléphone :");
                painter.drawText(1000, 1600+i, query.value(3).toString());
                painter.drawText(100, 1800+i, "Adresse :");
                painter.drawText(1000, 1800+i, query.value(4).toString());
                i=i+1900;
            }
            painter.end();
       }
    ...
    if (dialog->exec() == QDialog::Accepted)
    {
        ...
        QPainter painter (&printer);
             ...
             QFont f;
              ...
              f.setBold(true);
              painter.setFont(f);
              painter.drawText(1600, 500, " La liste des assurances:");
        if (query.exec())
        {
            while (query.next())
            {
                ...
                painter.drawText(100, 1200+i, "nom :");
                painter.drawText(1000, 1200+i, query.value(1).toString());
                painter.drawText(100, 1400+i, "type :");
                painter.drawText(1000, 1400+i, query.value(2).toString());
                painter.drawText(100, 1600+i, "Date de fin :");
                painter.drawText(1000, 1600+i, query.value(3).toString());
                painter.drawText(100, 1800+i, "ID voiture :");
                painter.drawText(1000, 1800+i, query.value(4).toString());
                painter.drawText(100, 2000+i, "ID assureur :");
                painter.drawText(1000, 2000+i, query.value(5).toString());
                i=i+2100;
            }
            painter.end();
       }
